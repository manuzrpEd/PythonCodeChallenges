...
# the Knuth–Morris–Pratt string-searching algorithm (or KMP algorithm) searches for occurrences of a 
# "word" W within a main "text string" S by employing the observation that when a mismatch occurs, 
